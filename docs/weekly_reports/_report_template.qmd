---
title: "Task 1: Geocoding CoStar Data"
...
We were able to run the US Census Geocoder on a subset of SF CoStar data, but encountered a scenario where places have "tie" entries (multiple coordinates found). Guidance on this is requested.
